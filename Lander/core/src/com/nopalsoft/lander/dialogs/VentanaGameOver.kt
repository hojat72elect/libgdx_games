 ...
 */
class VentanaGameOver(var game: MainLander, var oWorld: WorldGame, val levelActual: Int) : Window("", Assets.styleDialogGameOver) {
    ...
    init {
        ...
        val paused = Label("Gameover", Assets.styleLabelMediana)
        val starTable = Table()
