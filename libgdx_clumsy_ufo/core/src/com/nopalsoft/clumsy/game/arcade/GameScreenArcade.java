...
public class GameScreenArcade extends Screens {
    ...
    public GameScreenArcade(final MainClumsy game) {
        super(game);
        Settings.numVecesJugadas++;
        oWorld = new WorldGameArcade();
        renderer = new WorldGameRendererArcade(batcher, oWorld);
        state = STATE_READY;
    ...
    private void inicializarGameOver() {
        ...
        btShareFacebook.addListener(new InputListener() {
            ...
            public void touchUp(InputEvent event, float x, float y,
                ...
                btShareFacebook.setPosition(295, 230);
                game.reqHandler
                        .shareOnFacebook("My best score playing arcade Clumsy ufo is "
        ...
        btShareTwitter.addListener(new InputListener() {
            ...
            public void touchUp(InputEvent event, float x, float y,
                ...
                btShareTwitter.setPosition(btShareTwitter.getX(),
                        btShareTwitter.getY() + 3);
                game.reqHandler
                        .shareOnTwitter("My best score playing arcade Clumsy ufo is "
                                + Settings.bestScoreArcade
                                + ", can you beat me?");
            }
        });
    ...
    private void setGameover() {
        ...
        game.gameServiceHandler.submitScore("CgkI0_DfzucDEAIQAg",
                (int) oWorld.score);
