...
/**
 * BaseTween is the base class of Tween and Timeline. It defines the iteration engine used to play animations for any number of
 * times, and in any direction, at any speed.
 * <p/>
 * <p>
...
public abstract class BaseTween<T> {
     ...
     * to ".start()" also calls this method.
     *
    ...
    /**
     * Starts or restarts the object unmanaged. You will need to take care of its life-cycle. If you want the tween to be managed
     * for you, use a {@link TweenManager}.
     *
     * @return The current object, for chaining instructions.
     */
    public T start() {
    ...
    /**
     * Stops and resets the tween or timeline, and sends it to its pool, for + * later reuse. Note that if you use a
     * {@link TweenManager}, this method + * is automatically called once the animation is finished.
     */
    public void free() {
    }
     ...
     *
     * @param count The number of repetitions. For infinite repetition, use Tween.INFINITY, or a negative number.
