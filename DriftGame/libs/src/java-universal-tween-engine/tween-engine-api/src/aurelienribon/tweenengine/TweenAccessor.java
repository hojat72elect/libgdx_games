...
/**
 * The TweenAccessor interface lets you interpolate any attribute from any object. Just implement it as you want and register it
 * to the engine by calling {@link Tween#registerAccessor}.
 * <p/>
 *
 * <h2>Example</h2>
 * <p>
 * The following code snippet presents an example of implementation for tweening a Particle class. This Particle class is supposed
 * to only define a position with an "x" and an "y" fields, and their associated getters and setters.
 * <p/>
 *
 * <pre>
 * {
 ...
 * </pre>
 * <p>
 * Once done, you only need to register this TweenAccessor once to be able to use it for every Particle objects in your
 * application:
 * <p/>
 *
 * <pre>
...
public interface TweenAccessor<T> {
    ...
    /**
     * This method is called by the Tween Engine each time a running tween associated with the current target object has been
     * updated.
     *
     * @param target    The target object of the tween.
     * @param tweenType An integer representing the tween type.
