...
interface TweenPath {
    ...
    /**
     * Computes the next value of the interpolation, based on its waypoints and the current progress.
     *
     * @param t The progress of the interpolation, between 0 and 1. May be out of these bounds if the easing equation involves some
     * kind of rebounds.
     ...
     */
    fun compute(t: Float, points: FloatArray, pointsCnt: Int): Float
}