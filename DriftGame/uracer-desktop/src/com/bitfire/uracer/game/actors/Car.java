...
public abstract strictfp class Car extends Box2DEntity {
    ...
    private final Vector2 distmp = new Vector2();
    ...
    private void applyCarPhysics(CarType carType, CarModel carModel) {
        ...
        fd.filter.groupIndex = (carType == CarType.PlayerCar) ? CollisionFilters.GroupPlayer : CollisionFilters.GroupReplay;
        fd.filter.categoryBits = (carType == CarType.PlayerCar) ? CollisionFilters.CategoryPlayer
