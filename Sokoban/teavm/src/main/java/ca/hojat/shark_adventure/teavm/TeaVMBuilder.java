package ca.hojat.shark_adventure.teavm;
...
public class TeaVMBuilder {
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("ca/hojat/shark_adventure/asset.extension");

        // Register any classes or packages that require reflection here:
        // TeaReflectionSupplier.addReflectionClass("ca.hojat.shark_adventure.reflect");
