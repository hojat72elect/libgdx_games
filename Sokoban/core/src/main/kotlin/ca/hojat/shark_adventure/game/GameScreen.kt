...
import ca.hojat.shark_adventure.Settings.setBestScore
import ca.hojat.shark_adventure.SharkAdventureGame
import ca.hojat.shark_adventure.scene2d.GameUI
import ca.hojat.shark_adventure.scene2d.MenuUI
import ca.hojat.shark_adventure.scene2d.PauseWindow
...
class GameScreen(game: SharkAdventureGame, showMainMenu: Boolean) : Screens(game) {
    ...
    private fun updateRunning(delta: Float) {
        ...
        if (gameWorld.state == GameWorld.Companion.STATE_GAME_OVER) {
            setGameOver()
        }
    }
