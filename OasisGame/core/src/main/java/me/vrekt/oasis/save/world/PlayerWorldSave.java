...
public final class PlayerWorldSave implements Disposable {
    ...
    private final int worldIn;

    @Expose
    @SerializedName("parent_world_id")
    private final int parentWorld;

    @Expose
    @SerializedName("is_in_interior")
    private final boolean inInterior;
    ...
    private final AbstractWorldSaveState world;

    @Expose
    @SerializedName("visited_worlds")
    private final Map<Integer, AbstractWorldSaveState> worlds;
