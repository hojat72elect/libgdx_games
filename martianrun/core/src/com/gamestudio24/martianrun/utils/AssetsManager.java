...
public class AssetsManager {
    ...
    private static final HashMap<String, TextureRegion> texturesMap = new HashMap<String, TextureRegion>();
    private static final HashMap<String, Animation> animationsMap = new HashMap<String, Animation>();
