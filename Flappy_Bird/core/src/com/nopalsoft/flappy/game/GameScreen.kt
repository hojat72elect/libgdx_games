...
class GameScreen(game: MainFlappyBird?) : Screens(game) {
    ...
    private var renderer = WorldGameRenderer(spriteBatch, oWorld)
    private var getReady = Image(Assets.getReady)
    private var tap = Image(Assets.tap)
    private var gameOver = Image(Assets.gameOver)
